...
Write `.adlc/verification-results.md`. The directory already exists — do not create it. Every criterion from the slice must appear in exactly one section (Passed or Failed).
