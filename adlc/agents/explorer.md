...
Read `.adlc/current-package-map.md` and `.adlc/current-slice.md`. The package map is pre-generated by the harness during worktree setup. If the file is missing, stop and report the error.
